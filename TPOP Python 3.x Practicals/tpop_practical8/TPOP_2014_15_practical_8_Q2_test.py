...
@author: Lilian
'''
from tpop_practical8.TPOP_2014_15_practical_8_Q2 import *
...
print 'adding:', '1 x', item6.get_name()
basket.add_item(item6, 1)

print 'adding:', '1 x', item7.get_name()
basket.add_item(item7, 1)

print basket

print 'remove:', '1 x', item6.get_name()
basket.remove_item(item6, 1)

print 'remove:', '5 x', item3.get_name()
basket.remove_item(item3, 5)

print 'remove:', '1 x', item7.get_name()
basket.remove_item(item7, 1)
